...
function findElement(x, y) {
	for (var i = this.mouse.interactiveElements.length - 1; i >= 0; --i) {
		if (this.mouse.interactiveElements[i].active && x < this.mouse.interactiveElements[i].getX() + this.mouse.interactiveElements[i].getWidth() && x > this.mouse.interactiveElements[i].getX() &&
			y < this.mouse.interactiveElements[i].getY() + this.mouse.interactiveElements[i].getHeight() && y > this.mouse.interactiveElements[i].getY()) {
